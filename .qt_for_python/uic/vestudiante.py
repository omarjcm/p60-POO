...
class Ui_VEstudiante(object):
    def setupUi(self, VEstudiante):
        ...
        self.titulo_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cedula_lbl)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.nombre_lbl)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.apellido_lbl)
        self.edad_lbl = QtWidgets.QLabel(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.edad_lbl.setFont(font)
        self.edad_lbl.setObjectName("edad_lbl")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.edad_lbl)
        self.cedula_txt = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.cedula_txt.setObjectName("cedula_txt")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cedula_txt)
        self.nombre_txt = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.nombre_txt.setObjectName("nombre_txt")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.nombre_txt)
        self.apellido_txt = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.apellido_txt.setObjectName("apellido_txt")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.apellido_txt)
        self.edad_txt = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.edad_txt.setObjectName("edad_txt")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.edad_txt)
